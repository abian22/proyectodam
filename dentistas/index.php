...
<head>
    ...
    <title><?php echo CONFIG_GENERAL['TITULO_WEB']; ?> - Dentistas</title>
...
<body>
    <?php include_once(__DIR__. "/modal/crear.editar.dentista.php"); ?>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 text-center">
                        <button class="btn btn-success" onclick="abrirModalDentista(0)">Añadir dentista</button>
                    </div>
                </div>
                <!-- Tabla listado dentistas -->
                <div class="row">
                    <div class="col-12">
                        <table class="table-striped tablaListado" id="tablaListadoDentistas" data-toggle="table"
                            data-url="<?php echo CONFIG_GENERAL['RUTA_URL_BASE'] . "/dentistas/GetJSONTablaDentistas.php"; ?>"
                            data-unique-id="id"
                            data-search="true"
