...
<head>
    ...
    <title><?php echo CONFIG_GENERAL['TITULO_WEB']; ?> - Entrenadores</title>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 text-center">
                            <button class="btn btn-primary" id="añadirEntrenador" onclick="abrirModalEntrenador(this, 0)">Añadir Entrenador</button>
                        </div>
                    </div>
